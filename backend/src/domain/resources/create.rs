use crate::domain::resources::entity::{
    ContentData, ContentID, CreateResourceRequest, Language, ResourceID, ResourceType,
};
...
pub async fn execute<F: UnitOfWorkFactory>(
    ...
    let id = ResourceID::try_from(Ulid::new().to_string())
        .map_err(|_| Error::Unknown("can't generate id".to_string()))?;
