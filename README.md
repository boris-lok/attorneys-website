...
1. docker buildx build --platform linux/amd64,linux/arm64 --tag backend:latest -f dockerfiles/Dockerfile.backend .
...
5. rename the images (docker tag backend:latest attorneys-website-backend:latest)
